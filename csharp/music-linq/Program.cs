...
namespace ConsoleApplication {
    public class Program {
        public static void Main (string[] args) {
            ...
            // 4. Display the 3 oldest artist from Atlanta
            ...
            // 5. (Optional) Display the Group Name of all groups that have members that are not from New York City
            ...
            // 6. (Optional) Display the artist names of all members of the group 'Wu-Tang Clan'
